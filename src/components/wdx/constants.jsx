export const ESW_SERIES = [
  { group: true, label: '── WINDOWS ──' },
  { group: true, label: '— Horizontal Roller —' },
  'ES-2000',
  'ES-2050',
  'ES-EL200',
  'ES-MX2000',
  'ES-SW340 LMI',
  'ES-V200 - HORIZONTAL ROLLER',
  'HR-2600 - LMI',
  { group: true, label: '— Casement —' },
  'ES-5000',
  'ES-P252 LMI - CASEMENT',
  'ES-V500 - CASEMENT',
  'HC-200 LMI',
  { group: true, label: '— Single Hung —' },
  '600T LMI',
  'ES-1000',
  'ES-1000WW',
  'ES-1050',
  ...
  'ES-1150WW',
  'ES-EL100',
  { group: true, label: '— Fixed Window —' },
  'ES-1500',
  'ES-8000 JUMBO',
  'ES-8000T JUMBO',
  'ES-EL150',
  'ES-MX1500',
  'ES-P252 LMI - FIXED WINDOW',
  'ES-V150 - FIXED WINDOW',
  { group: true, label: '— Fixed Casement —' },
  'ES-5100',
  { group: true, label: '— Awning —' },
  'ES-5500',
  'ES-5600',
  'ES-P252 LMI AWNING',
  'ES-V550 - AWNING',
  ...
  { group: true, label: '— Swing Door —' },
  'ES-3001',
  'ES-9000 - INSWING DOOR',
  'ES-9000',
  'ES-9100',
  'ES-EL300',
  'ES-MX3000',
  'ES-PSD5030T DOOR',
  { group: true, label: '— Bi-Fold Door —' },
  'ES-BF5010T',
  { group: true, label: '— Sliding Glass Door —' },
  'ES-6000 INSULAMINATED',
  'ES-6000 LAMINATED',
  'ES-EL400 - SLIDING GLASS DOOR',
  'ES-MX4000',
  'ES-SD450',
  'ES-SD451 LMI',
  'ES-SGD2020 - SLIDING GLASS DOOR',
  { group: true, label: '── STOREFRONT ──' },
  'ES-7000',
  'ES-7100',
  'ES-7500',
  'ES-7600',
  'ES-8000 - STOREFRONT',
  'ES-8000T LMI - STOREFRONT',
  'ES-8860 LMI',
  { group: true, label: '── SHAPE ──' },
  'ES-8000 SHAPE',
  'ES-EL150 SHAPE',
  'ES-MX1500 SHAPE',
  'ES-V150 SHAPE - FIXED WINDOW',
];

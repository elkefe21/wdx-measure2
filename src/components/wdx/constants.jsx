...
export const SERIES_CONFIGS = {
  ...
  // ESW Shape
  'ES-8000 SHAPE': ['ARC', 'TOMBSTONE', 'HALF CIRCLE', 'FULL CIRCLE', 'EYEBROW', 'TRAPEZOID L', 'TRAPEZOID R'],
  'ES-EL150 SHAPE': ['ARC', 'TOMBSTONE', 'HALF CIRCLE', 'FULL CIRCLE', 'EYEBROW', 'TRAPEZOID L', 'TRAPEZOID R'],
  'ES-MX1500 SHAPE': ['ARC', 'TOMBSTONE', 'HALF CIRCLE', 'FULL CIRCLE', 'EYEBROW', 'TRAPEZOID L', 'TRAPEZOID R'],
  'ES-V150 SHAPE - FIXED WINDOW': ['ARC', 'TOMBSTONE', 'HALF CIRCLE', 'FULL CIRCLE', 'EYEBROW', 'TRAPEZOID L', 'TRAPEZOID R'],
};
